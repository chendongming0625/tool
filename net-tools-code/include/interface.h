...
extern InterFaceInfo *do_if_get(struct interface *ife, void *cookie);
extern CelArrayList *for_all_get_interfaces(InterFaceInfo*(*doit)(struct interface *, void *), void *cookie);
